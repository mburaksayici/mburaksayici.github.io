...
[PromptingGuide AI](https://www.promptingguide.ai/techniques) and [this Digital Adoption Blog](https://www.digital-adoption.com/types-of-prompt-engineering/) have the best content on the types of prompting. So my resources would mostly relay on them. 

| ![Image](https://www.digital-adoption.com/wp-content/uploads/2024/11/10-Types-of-prompt-engineering-for-generative-AI.jpg "Prompt Types"){: width="90%" style="display:block; margin-left:auto; margin-right:auto"}| 
|:--:| 
| [Types of Prompts Engineering by Digital Adoption](https://www.digital-adoption.com/types-of-prompt-engineering/) 
 |    
...
You also explain what to do with few examples.
I remember the days where professors in Bilkent University studying few-shot prompting in 2018-19, Gokberk Cinbis and the other lady. I was thinking, "it's impossible" that day. 
...
> USER :  This is awesome! // negative
> USER :  This is promising! // positive
...
It's mostly used in [Document QA or retrieval-based pipelines](https://www.promptingguide.ai/techniques/prompt_chaining).
...
> 1. You start with 4 pens.  
> 2. You buy 3 more pens.  
> 3. Adding them together: 4 + 3 = 7.  
> Answer: 7

### 8. What is hallucination, and how can it be controlled using prompt engineering?

Hallucinations are false, fabricated, or inconsistent outputs generated by LLMs that do not align with the input or real-world facts [here](https://www.lakera.ai/blog/guide-to-hallucinations-in-large-language-models), [here](https://www.iguazio.com/glossary/llm-hallucination/), [here](https://en.wikipedia.org/wiki/Hallucination_(artificial_intelligence)), [here](https://www.machinelearningmastery.com/a-gentle-introduction-to-hallucinations-in-large-language-models/).

Reasons:
- Training data biases and gaps  
- Limited contextual understanding of models  
- Incomplete or misleading prompts  
- Model architecture and stochastic decoding flaws [here](https://www.iguazio.com/glossary/llm-hallucination/), [here](https://ai.plainenglish.io/hallucination-in-large-language-models-08871ba468d1?gi=a1d4dc5e0b44), [here](https://bookdown.org/tranhungydhcm/mybook/hallucination-control-techniques.html).
...
[here](https://bookdown.org/tranhungydhcm/mybook/hallucination-control-techniques.html)

How to detect: 
- Analyzing prompts for ambiguity  
- Consistency and cross-checks within generated content  
- External fact verification using knowledge bases or APIs [here](https://bookdown.org/tranhungydhcm/mybook/hallucination-control-techniques.html)
...
- Combine with retrieval-augmented generation (RAG) to ground outputs in verified external knowledge [here](https://bookdown.org/tranhungydhcm/mybook/hallucination-control-techniques.html)
...
- Grounds outputs in real data, significantly reducing hallucinations [here](https://bookdown.org/tranhungydhcm/mybook/hallucination-control-techniques.html)


Fully eliminating hallucinations is not currently possible due to inherent model limitations and learning constraints [here](https://arxiv.org/abs/2401.11817)
